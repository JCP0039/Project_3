...
public class StoreManager {
    ...
    public static final String DB_FILE = "C:\\Users\\James\\IdeaProjects\\Activity01\\src\\main\\java\\store.db";
    ...
    public static void main(String[] args) {
        System.out.println("Hello TA! Thanks for grading all of these.");
